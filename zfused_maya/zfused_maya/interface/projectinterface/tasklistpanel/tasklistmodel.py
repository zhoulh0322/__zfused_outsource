...
__all__ = ["TaskListFilterProxyModel", "TaskListModel"]

_logger = logging.getLogger(__name__)


class TaskListFilterProxyModel(QtCore.QSortFilterProxyModel):
    def __init__(self, parent=None):
        super(TaskListFilterProxyModel, self).__init__(parent)
