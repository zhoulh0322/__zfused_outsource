...
__all__ = ["InsideLoginWidget"]

logger = logging.getLogger(__name__)


class InsideLoginWidget(QtWidgets.QFrame):
    def __init__(self, parent=None):
        super(InsideLoginWidget, self).__init__(parent)
        self._build()
        self.loadConfig()
    ...
    def _set_address(self):
        ...
        print(type(_address_name))
        if _address_name and isinstance(_address_name, unicode):
    ...
    def _build(self):
        ...
        self.name_password_layout = QtWidgets.QVBoxLayout(
            self.name_password_frame)
        ...
        self.login_layout.addWidget(self.address_frame)
